...
class Spella : CliktCommand(name = "spella", treatUnknownOptionsAsArgs = true) {
    ...
    val distances by option("--distances", help = "A comma separated list of allowed edit distances. The numbers represent the string lenghts (default: 3,10)").default("3,10")
